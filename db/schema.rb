...
ActiveRecord::Schema.define(version: 2021_11_02_210525) do
  ...
  create_table "deriveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["record_id"], name: "index_deriveries_on_record_id"
  end
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "record_id", null: false
    t.bigint "derivery_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["derivery_id"], name: "index_orders_on_derivery_id"
  ...
  add_foreign_key "deriveries", "records"
  add_foreign_key "items", "users"
  add_foreign_key "orders", "deriveries"
